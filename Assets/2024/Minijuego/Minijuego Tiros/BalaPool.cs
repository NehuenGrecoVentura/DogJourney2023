...
public class BalaPool<T> //Cuando yo haga un new ObjectPool voy a tener que setear que tipo va a ser, en ESTE ejemplo va a ser tipo Bullet
{
    ...
    public BalaPool(FactoryMethod factoryMethod, Action<T> turnOnCallback, Action<T> turnOffCallback, int initialStock = 0, bool isDynamic = true)
    {
